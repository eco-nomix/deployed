                 ...
                 <div class="panel-heading">{{$Product->product_name}}
                        ...
                        @endif
                         ...
                         @if($ccard == "yes" )
                            ...
                            <span title="single-click to add; double-click to view" data-id="{{$Product->id}}" data-userid="{{$user->id}}" class="pull-right addcart" style="margin-right: 10px;">Add to Cart&nbsp;&nbsp;<img width="40px" src="{{URL::to('/')}}/images/shopping_cart_small.jpg">&nbsp;&nbsp;<span id="cartcount">{{$ItemCount}}</span></span>
                            &nbsp;&nbsp;&nbsp;
                       @else
                             <h1> <b> Please add card </b></h1>
                        @endif
