...
<div class="container-fluid">
 <div class="pagecontainer"><img src="{{URL::to('/')}}/images/Products-small.jpg" ></div>
            ...
            {{--<div class="panel panel-default display">--}}
                ...
                {{--<div class="panel-body">--}}
                    ...
                    {{--</div>--}}
                     ...
                     {{--</div>--}}
                    {{--<div class="form-group col-md-12 ">--}}
                    {{--Each of the products on thKineticGoldix websites participate in the Referral Bonuses.  This expansive capability will eventually offer an "Amazon" range of products that can benefit our members financially.--}}
                    {{--</div>--}}
