                 ...
                 <div class="panel-body">
                         ...
                         <input type="hidden" name="_token" value="{{ csrf_token() }}">
                          <div class="form-group col-md-12 ">
                              One the major factors that impact nearly every company the utilizes multi-level payment schemes is member 'churn'.  Church is the description of the process where
