                    ...
                    <div class="panel-body">
                        ...
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                         <div class="form-group col-md-12 ">
                                ...
                                <div class="form-group col-md-12 ">
                                Kinetic Gold has a unique systems of Rewards and Profit Sharing that will enable even the newest and smallest user to be able to generate immediate profit.  These rewards and profit sharing are also controlled by the block chain. </div>
                                <div class="form-group col-md-12 ">
