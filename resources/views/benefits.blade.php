...
{{--<div class="form-group benefits">--}}
    {{--<div class="col-md-12 indent">--}}
        {{--<p>KineticGold is a unique company dedicated in delivering the highest quality products to its customers. <br><br> KineticGold's purposes will help them improve their lives <a href="\physically">physically</a>, <a href="\emotionally">emotionally</a>, <a href="\spiritually">spiritually</a>, <a href="\economically">economically</a> and to become more <a href="\selfreliance">self-reliant.</a>--}}
        {{--<br><br>Summary of KineticGold's Marketing plan.--}}
        {{--.--}}
        {{--</p>--}}
        ...
        {{--<ol>--}}
            ...
            {{--</li>--}}
            {{--<li>--}}
                {{--<p>The <a href="\selection">products</a> carried by KineticGold are not typically carried by your local retailers.  We specialize in products that are made from recycled materials, helping you reduce your carbon footprint.  Products are also offered to help you--}}
                ...
                {{--<p> The basic idea is to help you create a lifestyle that is in tune with nature, that is 100% sustainable and as independent as possible while helping to reduce the negative impact to the environment. Any product that can help you live better, on or off the grid, increase your spirituality, help you get through hard times and prepare for the future will eventually be available at KineticGold.</p>--}}
                {{--<p> In addition to KineticGold's unique products, the Members are also allowed to create their own stores, boutiques and special sales of products within the KineticGold site.  These products also generate Referral Bonuses that benefit all.  These products can be anything from hand made items, to garage sales specials or even custom art.  Literally anything could be listed there.</p>--}}
            {{--</li>--}}
            {{--<li>--}}
            ...
            {{--<li>--}}
                {{--<p>Referral Bonuses can be used to purchase any of the KineticGold products by Fully Registered Members</p>--}}
            ...
            {{--<li>--}}
                {{--<p>Members that own an KineticGold Debit card can have their Referral Bonuses transferred to that card when <a href="\transfers">requested by the member</a>.  No waiting to the end of the month for processing, no delays due to the mail.</p>--}}
            {{--</li>--}}
            {{--<li>--}}
            ...
            {{--</li>--}}
            {{--<li>--}}
                {{--<p>The <a href="\selection">products chosen</a> to be marketed by KineticGold are determined first to be priced competitively, even against the major brand stores.  The products used high quality materials and have a benefit to the ecology.  All the products are tested against the manufactures claims and can be relied upon.--}}
            {{--</li>--}}
            {{--<li>--}}
                {{--<p>Member's of KineticGold share their <a href="\experiences">experiences</a>, evaluate and recommend products.  You are not alone in deciding what products will benefit your family the most.</p>--}}
            {{--</li>--}}
            {{--<li>--}}
            ...
            {{--</li>--}}
            {{--<li>--}}
                {{--<p>KineticGold is poised to create the maximum income potential in <a href="\comparison">comparison</a> to other Multi-Level marketing programs.--}}
            {{--</li>--}}
        {{--</ol>--}}
    ...
    {{--<div class="form-group benefits">--}}
       {{--<div class="col-md-12 standout">--}}
          {{--<p>All these significant differences show you why KineticGold is positioned to make a real difference in your life.  The right products, for the right reasons, will help you to prepare--}}
