...
@section('content')
   <div style="z-index:-5; overflow-y:scroll; height: 100%; background-size:cover; background-attachment:fixed;  background-image:url('/images/denmark.jpeg');">
    ...
    <div class="trans display  back-white col-md-10 col-md-offset-1" style="font-size:16px;">
    ...
    <div class="trans display  back-white col-md-10 col-md-offset-1" >
            ...
            <p>You will be able to access your Kinetic Gold account to make payments at any local merchants that accept Visa/Mastercard.</p>
            <p>There are no minimum or maximum transaction sizes.</p>
            ...
            <p>The cryptocurrency feature of decentralized transactions allows for very secure transactions, permanent records
    ...
    <div class="trans display back-white  col-md-10 col-md-offset-1" >
            ...
            <p>Debit Card will be branded with Mastercard or Visa and can be used anywhere, including ATMs, accepting these brands</p>
          ...
          <ul>
            ...
            <li>Because the Off-Shore bank and Kinetic Gold's blockchain is not complete the following limitations will be in effect</li>
                 <ul>
                    ...
                    <li>Payment of the Registration fee ($39.95) for the Gold Digger's Association will be paid through ACH or E-Checks.</li>
                    <ul>
                        <li>Payment processing on site will request routing and bank account number for an electronic check</li>
                        <li>Payment processing is preformed by a independent ACH/E-check processor</li>
                        <li>KineticGold and the Gold Digger's Association will not have access to your banking details.</li>
                    </ul>
