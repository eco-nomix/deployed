...
@section('content')
   ...
   <div >
    ...
    <div class="display container-fluid back-white" >
                ...
                <p>Unlike your standard bank account, your account is denominated in ounces of Gold, insured to the full value of your deposits (no $250,000 limit) by Lloyds of London, and can be used within any country.</p>
     ...
     <div class="center kinetic">
        ...
        <div class="display container-fluid back-white" >
                    <p>Kinetic Gold's coin is equivalent to 1 oz of fine gold at spot value.  This is established by requiring before any coin is issued that there there will be set aside one of the ounces of Gold in our insured vaults.  The coin technically represents a warehouse receipt for 1 ounce of Gold at spot price.</p>
                    <p>With any member's deposit into their account the deposit funds are used to purchase additional gold for Kinetic Gold's reserves.</p>
                    <p>The Spot price of gold is essentially it's wholesale price.  This means that you control one ounce of Gold per Coin purchased without having to pay miniting costs, vaulting costs, insurance or shipping.  When a standard purchase of coins or bullion is made these costs will be incurred which could reach as high as 10% of the purchase.</p>
                    ...
                    <p>Unlike other cryptocurrencies, the value of the coin is not determined by scarcity as additional coins are being added continuously along with additional gold deposits.</p>
        </div>
        <div class="center kinetic">
                    <p>Vaulted Storage</p>
        </div>
        ...
        <div class="display container-fluid back-white" >
                            <p>During the Pre-Launch phase an off-shore bank will be obtained on the island of Nevis.</p>
