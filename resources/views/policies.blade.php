                ...
                <div class="panel-body">
                      ...
                      3.5 Sponsorship
                       ...
                       <div class="form-group col-md-12 ">
                        ...
                        <div class="form-group col-md-12 ">
                         <ol type="A">
                         <li>Eco-Nomix offers a one hundred percent (100%) thirty-day money back guarantee for all Customers, regardless of the product purchased.</li>
                         <li>With respect to Members, Eco-Nomix offers various refund opportunities depending on the product or service purchased.  Shipping and handling charges incurred will not be refunded.</li>
                       ...
                       <div class="form-group col-md-12 ">
                        ...
                        <p style="margin-left: 20px">CANCEL: The termination of a Member’s business. Cancellation may be either voluntary, involuntary, or through non-renewal.</p>

                        <p style="margin-left: 20px">COMPENSATION PLAN: The guidelines and referenced literature for describing how Members can generate commissions and bonuses.</p>

                        <p style="margin-left: 20px">CUSTOMER: A Customer who purchases Eco-Nomix products and does not engage in building a business or retailing product.</p>

                        <p style="margin-left: 20px">Member: An individual, who purchases product, generates retail sales and business building Referral Bonuses.</p>

                        <p style="margin-left: 20px">LINE OF SPONSORSHIP (LOS): A report generated by Eco-Nomix that provides critical data relating to the identities of Members, sales information, and enrollment activity of each Member’s organization. This report contains confidential and trade secret information which is proprietary to Eco-Nomix.</p>

                        <p style="margin-left: 20px">ORGANIZATION: The Customers and Members placed below a particular Member.  For purposes of Referral Bonuses this is limited to 5 generations.</p>

                        <p style="margin-left: 20px">OFFICIAL Eco-Nomix MATERIAL: Literature, audio or video tapes, and other materials developed, printed, published, and distributed by Eco-Nomix Members.</p>

                        <p style="margin-left: 20px">PLACEMENT: Your position inside your Sponsor’s organization.</p>

                        <p style="margin-left: 20px">RECRUIT: For purposes of Eco-Nomix’s Conflict of Interest Policy, the term “Recruit” means the actual or attempted solicitation, enrollment, encouragement, or effort to influence in any other way, either directly, indirectly, or through a third party, another Eco-Nomix Member or Customer to enrol or participate in another multilevel marketing, network marketing, or direct sales opportunity.</p>

                        <p style="margin-left: 20px">RESALABLE: Products shall be deemed “resalable” if each of the following elements is satisfied: 1) they are unopened and unused, 2) original packaging and labelling has not been altered or damaged, 3) they are in a condition such that it is a commercially reasonable practice within the trade to sell the merchandise at full price, and 4) the product contains current Eco-Nomix labelling. Any merchandise that is clearly identified at the time of sale as nonreturnable, discontinued, or as a seasonal item, shall not be resalable.</p>

                        <p style="margin-left: 20px">SPONSOR: A Member who enrolls a Customer, Retailer, or another Member into the Company, and is listed as the Sponsor on the MemberAgreement. The act of enrolling others and training them to become Members is called “sponsoring.”</p>

                        <p style="margin-left: 20px">UPLINE: This term refers to the Member or Members above a particular Member in a sponsorship line up to the Company. It is the line of sponsors that links any particular Member to the Company.</p>
                        </div>
                </div>
            </div>
