    ...
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand brand-image" href="{{ url('/') }}">
                <img src="{{ url('images/Economix3731_Fotor.jpg') }}" width="150" height="24">
            </a>
        </div>
        <h6 class="custom-header-h6">
            @if(!isset($referral_link))
                Your Referral Link: Not logged in
            @else
        ...
        <ul class="nav navbar-nav">
            <li class="dropdown">
                <a href="{{url('products')}}" class="dropdown-toggle" data-toggle="dropdown" href="#">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a href="{{URL::to('/')}}/stores/39">
                            Art Galleries
                        </a>
                    </li>
                    <li>
                        <a href="{{URL::to('/')}}/stores/38">
                            Boutiques
                        </a>
                    </li>
                    ...
                    <li><a href="{{URL::to('/')}}/store/10">Member Tools</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="{{URL::to('/')}}/traininglinks" class="dropdown-toggle" data-toggle="dropdown" href="#">
                    Training Links<span class="caret"></span>
                </a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                <a href="{{URL::to('/')}}/people" class="dropdown-toggle" data-toggle="dropdown" href="#">
            ...
            <li class="dropdown">
                <a href="{{URL::to('/')}}/purpose" class="dropdown-toggle" data-toggle="dropdown" href="#">
            ...
            <li class="dropdown">
                <a href="{{URL::to('/')}}/plans" class="dropdown-toggle" data-toggle="dropdown" href="#">
            ...
            <li class="dropdown">
                <a href="{{URL::to('/')}}/policies" class="dropdown-toggle" data-toggle="dropdown" href="#">
                    Policies and Procedures<span class="caret"></span>
                </a>
                <ul class="dropdown-menu">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            @else
                <li class="dropdown">
                    <a href="{{URL::to('/')}}/homepage/{{$user_id}}" class="dropdown-toggle" data-toggle="dropdown" href="#">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @if($userRoles[6]=='yes')
                            <li>
                                <a href="{{URL::to('/')}}/xy/admin/financial">Finance</a>
                            </li>
                        @endif
                        @if($userRoles[5]=='yes')
