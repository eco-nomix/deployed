...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('/autoship4', ['as' => 'autoship4','uses'=>'PagesController@autoship4']);
    ...
    Route::get('/active', ['as' => 'active','uses'=>'PagesController@active']);
    ...
    Route::get('/limitations4', ['as' => 'limitations4','uses'=>'PagesController@limitations4']);
    ...
    Route::get('/memagreement4', ['as' => 'memberagreement4','uses'=>'PagesController@memberagreement4']);
    ...
    Route::get('/mem_terms3', ['as' => 'memberaterms3','uses'=>'PagesController@memberterms3']);
    Route::get('/memberterms4', ['as' => 'memberaterms4','uses'=>'PagesController@memberterms4']);
    ...
    Route::get('/purpose3', ['as' => 'purpose3','uses'=>'PagesController@purpose3']);
    ...
    Route::get('/plans3', ['as' => 'plans3','uses'=>'PagesController@plans3']);
    ...
    Route::get('/returns3', ['as' => 'returns3','uses'=>'PagesController@returns3']);
    ...
    Route::get('/tchamgang', ['as'=>'tchamgang','uses'=>'PagesController@tchamgang']);
