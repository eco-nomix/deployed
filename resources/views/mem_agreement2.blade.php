        ...
        <div class="col-md-8 col-md-offset-2">
            <div style="width:100%;">
                <div class="kinetic600">
                       Gold Diggers Association Member Agreement
                </div>
            </div>
            <div class="panel panel-default display">
                ...
                <div class="panel-body">
                        ...
                        By registering with Golddiggerz.org and using this website, each user agrees, understands, and warrants the following:
                        <br><br>
                        Gold Diggers Association is a for-profit website created for the purpose of selling Association memberships and products.
                        Access to golddiggerz.org is generally open to the public, with the only limitation being to
                        individualized pages that are accessible only through logging in.
                        <br><br>
                        By registering with golddiggers.org, each user agrees to view text and/or material that is or may be false,
                        ...
                        user may not post any text or material that violates any United States or Tennessee law, or the policies of golddiggerz.org
                        as explained herein.  Each user also explicitly agrees not to post to golddiggerz.org any copyrighted, trademarked,
                        ...
                        <br><br>
                        Golddiggerz.org does not allow any type of solicitation, including but not limited to advertisements, junk mail,
                        directed mail, “spam”, chain letters, or pyramid schemes, Ponzi schemes, or “multi-level marketing” beyond the official
                        site functionality of golddiggerz.org.
                        <br><br>
                        Each user understands and agrees that it is impossible for anyone associated with golddiggerz.org to
                        confirm the validity or provenance of any content posted by users of the site.  No person associated with
                        golddiggerz.org monitors or is responsible for the posted content.   No person associated with golddiggerz.org
                        ...
                        express only the views of the author, and not necessary the views of any administrator or owner of golddiggerz.org.
                        ...
                        this website have the right to remove or modify any content posted to golddiggerz.org (including member profile
                        ...
                        golddiggerz.org, each user agrees to indemnify, defend, and hold hairless the owners and administrators of this
                        website for any claim related to the user’s posted text or material.
                        <br><br>
                        The owners and administrators of golddiggerz.org adhere to two written rules with respect to posted text and
                        material:  (1) no pornography: and (2) no overt racism.  These limited rules are intended to allow a very reasonable
                        method that the user may promote their products through golddiggerz.org.  Any user that does not follow this basic
                        guideline may have their product descriptions edited or the products removed completely.
                        <br><br>
                        Gold Diggers Assoication does not use any type of advertising or tracking software.
                        <br><br>
                        By joining and using golddiggers.org, each user agrees, understands and warrants that, as with every use of
                        the internet, the User’s Anonymity cannot be protected.  To the contrary, Each user’s personally identifying
                        information is always viewable by the administrators and owners of golddiggers.org.  The owners of golddiggers.org,
                        ...
                        <br><br>
                        Golddiggers.org shall maintain a money-back policy for all of its products less a reasonable restocking fee.
                        Vendors selling products through Golddiggers.org shall also be subject to such.  Any customized products created for
                        the user such as business cards and debit-cards are exempt from a return policy.
                        <br><br>
                        Registered users can request that their benefits be cancelled at any time, without cost, through the golddiggers.org website.
                        <br><br>
