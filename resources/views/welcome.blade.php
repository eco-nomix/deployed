...
@section('content')
   ...
   <div >
    ...
    <div class="display container-fluid back-white" >
            ...
            <p>By its design Kinetic Gold is designed to a benefit to the small account holder, allowing them the
               ...
               of Rewards.  The Rewards alone can add up to hundreds of dollars worth of Gold to your account on a monthly basis. </p>
    </div>
     <div class="center kinetic">
    ...
    <div class="display container-fluid back-white" >
            <p>Kinetic Gold's coin is equivalent to 1 oz of fine gold at spot value.  This is established by
               requiring before any coin is issued that there there will be set aside one of the ounces of Gold
