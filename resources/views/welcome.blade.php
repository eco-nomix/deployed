...
@section('content')
   <div style="z-index:-5; height:1500px; background-attachment:fixed; background-size:100% 100%; background-image:url('/images/denmark.jpeg');">
    <div >
    ...
    <div class="center " style="border-color:red">
    ...
    <div class="display container-fluid back-white col-md-10 col-md-offset-1" >
            ...
            <p>By its design Kinetic Gold is designed to be a benefit to the small account holder, allowing them the
               ...
               Just by using Kinetic Gold like your standard bank account you automatically qualify for a significant amount
               of Rewards.  Without changing your income or spending habits, you see large benefits.  The Rewards alone can
