                 ...
                 <div class="panel-body">
                         ...
                         <input type="hidden" name="_token" value="{{ csrf_token() }}">
                          ...
                          <div class="form-group col-md-12 ">
                              ...
                              how you go about this exploration, but that you do it.  It may be expressed within a religous belief, or a sense of wonder as you walk in the forest, but either way your life is enhanced by a spiritual path.
                          </div>
                          <div class="form-group col-md-12 ">
