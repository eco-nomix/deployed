                 ...
                 <div class="panel-body">
                         ...
                         <input type="hidden" name="_token" value="{{ csrf_token() }}">
                          <div class="form-group col-md-12 ">
                              xxx One the major factors that impact nearly every company the utilizes multi-level payment schemes is member 'churn'.  Churn is the description of the process where
                          ...
                          <div class="form-group col-md-12 ">
                              Churn is the biggest factor in why people rarely succeed with multi-level.  By the time their organization finally is big enough to qualify for that first promotion, their recruits start to churn, and it seems
                              like you never quite get there.  Meanwhile the costs keep racking up and few have little or nothing to show for it.  In one multi-level organization the average monthly commissions is $13.00.  And that is not even
                              half of what the monthly product subscription amounts too.
                          ...
                          <div class="form-group col-md-12 ">
                              Can you imagine that member being 4 generations away, and they make that purchase?  Even if it had been years ago, you will still receive a referral bonus!  Those bonuses are always a nice surprise.  So would you quit so to stop receiving bonuses out of thin air?  I don't think so.
                          </div>
                          <div class="form-group col-md-12 ">
                          ...
                          <div class="form-group col-md-12 ">
                              ...
                              <ul>
                                ...
                                <li>Month 7 - 63 total (You are limited to 5 generation of referral fees)</li>
                          ...
                          <div class="form-group col-md-12 ">
                            At this point lets say they were averaging $20 per month in purchases.  (Within a year I expect to have over 1000 products, so I hope this average is a bit higher)
                               ...
                               but most people if they are interested will recruit not just 1 per month but higher.  Than the numbers get really crazy.
