        ...
        <table width="100%" height="750px" border="1">
            ...
            <td width="300px">
                <table width="100%" height="750px" border="1">
                    <tr height="50%">
                        <td >
                        <img src="../images/fchamgang 1.jpeg" width="300" height="370" />
                        </td>

                    </tr>
                    <tr height="50%">
                         <td>
                          <img src="../images/fchamgang 2.jpeg" width="300" height="370" />
            ...
            <td width="300px">
                <table width="100%" height="750px" border="1">
                    <tr height="50%">
                       <td>
                             <img src="../images/fchamgang 3.jpeg" width="300" height="370" />
                                                  ;
                       </td>
