                        ...
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                         ...
                         <div class="form-group col-md-12 ">
                            ...
                            7.1 Introduction
                             ...
                             <div class="form-group col-md-12 ">
                            <p style="KineticGoldft: 20px">This Privacy Policy is to ensure that all Customers and Members understand and adhere to The TIB Foundation principles of confidetiality</p>
                            </div>
                            <div class="form-group col-md-12 ">
                            ...
                            <div class="form-group col-md-12 ">
                                <ol type="A">
                                    ...
                                    <li>The TIB Foundation will not disclose any personal information to outside third parties unless required by law.</li>
                                </ol>
                            </div>
                            <div class="form-group col-md-12 ">
